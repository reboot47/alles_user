...
import '../registration/verification_code_screen.dart';

class ResetPhoneInputScreen extends StatefulWidget {
  const ResetPhoneInputScreen({Key? key}) : super(key: key);

  @override
  State<ResetPhoneInputScreen> createState() => _ResetPhoneInputScreenState();
}

class _ResetPhoneInputScreenState extends State<ResetPhoneInputScreen> {
      ...
      try {
        ...
        if (!exists) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(content: Text('この電話番号は登録されていません。新規登録を行ってください。')),
          );
          setState(() {
            _isLoading = false;
          });
        ...
        Navigator.push(
          ...
          MaterialPageRoute(
            builder: (context) => VerificationCodeScreen(
              ...
              isRegistration: false, // パスワードリセット用
            ),
          ),
        );
      } catch (e) {
